...
def write_title_file(title: str, dictionary: dict):
    """
    Writes the dictionary of documents to titles into a file to be read in 
    querying
    output looks like:
    id1::title1
    id2::title2
...
def write_words_file(words: str, words_to_doc_relevance: dict):
    ...
    :param words_to_doc_relevance: the dictionary that provides words -> ids ->
    term relevance
    :return: n/a
    """
...
def read_title_file(titles: str, ids_to_titles: dict):
    ...
    :param ids_to_titles: the dictionary that ids and title will get written 
    into
    :return: n/a
    """
...
def read_words_file(words: str, words_to_doc_relevance: dict):
    """
    reads in the term relevance written in words into words_to_doc_relevance 
    dictionary
    :param words: the file name that the words_to_doc_frequency dictionary was 
    written to
    :param words_to_doc_frequency: a double dictionary, where a word is a key 
    to a dictionary
